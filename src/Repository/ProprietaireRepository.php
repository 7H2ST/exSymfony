 ...
 */
class ProprietaireRepository extends ServiceEntityRepository implements UserLoaderInterface
{
    ...
    public function loadUserByUsername($username): ?Proprietaire
    {
    ...
    public function loadUserByIdentifier(string $usernameOrEmail): ?Proprietaire
    {
        $entityManager = $this->getEntityManager();

        return $entityManager->createQuery(
                'SELECT u
                FROM App\Entity\Proprietaire u
